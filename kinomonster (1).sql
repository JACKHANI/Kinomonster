...
--
-- Хост: 127.0.0.1
-- Время создания: Фев 22 2021 г., 13:13
...
(609, 'the-finest-hours', 'И грянул шторм', 'Сюжет фильма основан на реальных событиях, произошедших в 1952 году, когда сотрудники береговой охраны в самый разгар шторма, используя деревянные моторные лодки, пытались спасти экипаж двух нефтяных танкеров.', 2015, 7.5, 'http://p.cinemate.cc/media/m/8/9/159198/0_ftD4QrT.big.jpg', 'https://www.youtube.com/embed/-1QOTS-OkIg?showinfo=0', 'Крэйг Гиллеспи', '2015-12-05 17:50:27', 1),
...
(612, 'the-revenant', 'Выживший', 'Охотник Хью Гласс серьезно ранен на неизведанных просторах американского Дикого Запада. Товарищ Хью по отряду покорителей новых земель Джон Фицжеральд предательски оставляет его умирать в одиночестве. Теперь у Гласса осталось только одно оружие — его сила воли. Он готов бросить вызов первобытной природе, суровой зиме и враждебным племенам индейцев, только чтобы выжить и отомстить Фицжеральду!', 2015, 10.0, 'http://p.cinemate.cc/media/m/0/9/155290/0_vSIywkv.big.jpg', 'https://www.youtube.com/embed/QRfj1VCg16Y?showinfo=0', 'Алехандро Гонсалес Иньярриту', '2016-01-12 17:50:27', 1),
...
(1, 'Регистрация', 'Мы добавили возможность регистрироваться', 'news-1'),
(2, 'Поиск', 'Мы добавили поиск', 'news-2'),
(3, 'Сериалы', 'Мы добавили сериалы', 'news-3');
...
(5, 2, 'admin', '$2y$10$Mc0JAYfEVfvkb07qe3EmhOULlR.A9TLpzi5BK4j1/q6VrMiZrJ1he', 'admin@test.com', 0, NULL, NULL, NULL, NULL, '127.0.0.1', '2021-02-20 15:09:17', '2016-01-08 14:37:09', '2021-02-20 14:09:17'),
(7, 1, 'user', '$2y$10$.0/HYgD.XMnjGOs2lEH79.5LHqFb.Vun2A7V7Y5Cm1UpWU1Z/.NT.', 'user@test.com', 0, NULL, NULL, NULL, NULL, '127.0.0.1', '2021-02-20 15:05:20', '2016-01-08 14:46:36', '2021-02-20 14:05:20');
